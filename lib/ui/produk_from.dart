...
class _ProdukFormState extends State<ProdukForm> {
  ...
  Widget _kodeProdukTextField() {
    return TextFormField(
      ...
      validator: (value) => (value == null || value.isEmpty) ? "Kode Produk harus diisi" : null,
    );
  }
  ...
  Widget _hargaProdukTextField() {
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (double.tryParse(value) == null) return "Harga Produk harus berupa angka";
        return null;
      },
    );
  }
  ...
  Widget _buttonSubmit() {
    return ElevatedButton(
      child: _isLoading ? const CircularProgressIndicator() : Text(_tombolSubmit),
  ...
  void _submit() async {
    ...
    try {
      Produk produk = Produk(
        ...
        hargaProduk: double.tryParse(_hargaProdukTextboxController.text)?.toInt() ?? 0,
      );
